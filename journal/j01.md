...
![The two primary windows in the FontForge interface](media/j01_1.png)
...
![A set of custom glyphs in the Font view](media/j01_2.png)
...
![Drag-selecting glyphs and adding them to a group](media/j01_3.gif)

Once the groups are defined, using the tool is simply a matter of choosing one or more and pressing *OK*.

![Hiding all glyphs except for the selected group](media/j01_4.gif)
...
![Creating a group based on color](media/j01_5.png)
...
![A set of custom glyphs in the Font view, but different](media/j01_6.png)
